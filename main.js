...
console.log(casseTete)

//Correspond aux index des places
let pieceArray = []
let pieceArrayObject = []
...
//Création de la grille. Chaque carré crée a une place fixe.
for(let i = 0 ; i<16 ; i++){
...
//Mélanger éléments du tableau pour en attribuer les index aux futurs conteneurs des morceaux d'images
...
for(let i=0; i<pieceImageArray.length; i++){
    ...
    imagePuzzle.src = "https://picsum.photos/400/400"
...
casseTete.addEventListener("click", (event)=>{
    ...
    //Détection de la victoire de la partie
    ...
    if(solutionArray.includes(false)){
        document.querySelector(".message").innerHTML = "Encore quelques efforts"
    } else {
        document.querySelector(".message").innerHTML = "C'est gagné !"
